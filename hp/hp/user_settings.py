...
DATABASES = {
    'default': {
        ...
        'NAME': 'hp',        # Or path to database file if using sqlite3.
...
TEMPLATE_DIRS = (
    ...
    os.path.join(os.path.dirname(__file__), 'templates/userTemplates').replace('\\','/'), #anil
    os.path.join(os.path.dirname(__file__), 'templates/forumTemplates').replace('\\','/'), #anil
)
